...
import { Validation, minLength, maxLength } from './../store/form/formField/formFieldWithValueValidation/UserNameField';
...
function errorMessageForUserName(error: undefined | ErrorKind): undefined | ErrorString {
    return error === undefined ? undefined : errorMap[error];
}

export default errorMessageForUserName;